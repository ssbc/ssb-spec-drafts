...
class BaseRfcWriter:
    ...
    boilerplate['status']['draft_s'] = [
       'SSB-Drafts are working documents of the Secure Scuttlebutt '
       'community.  Note that other groups may also distribute '
       'working documents as SSB-Drafts.',
       #
       'SSB-Drafts are draft documents valid for a maximum of six months '
       'and may be updated, replaced, or obsoleted by other documents at any '
       'time.  It is inappropriate to use SSB-Drafts as reference '
       'material or to cite them other than as "work in progress."']
    """
       'Internet-Drafts are working documents of the Internet Engineering '
       'Task Force (IETF).  Note that other groups may also distribute '
    ...
    boilerplate['draft_expire'] = \
       'This SSB-Draft will expire on %s.'
    ...
    boilerplate['base_copyright_header'] = \
        'Copyright (c) %s SSB Council and the persons identified as the ' \
